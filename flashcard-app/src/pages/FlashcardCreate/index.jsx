    ...
    return(
        <div className="create-page">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <h3>Word / Phrase</h3>
                <input className="input-boxes" type="text" name="words" placeholder="Example: Hello" value={wordText} onChange={handleWordChange}/>
                <h3>Answer</h3>
                <input  className="input-boxes" type="text" name="answers" placeholder="Example: Ola" value={answerText} onChange={handleAnswerChange}/>
